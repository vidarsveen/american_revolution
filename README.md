...
### 3. Write the chapter — `content/<id>/script.<chapter>.md`
...
```bash
python tools/author.py --new italy-wine/chapter-2-toscana    # from the outline
...
content/<id>/
  ...
  script.*.md      one chapter each, as prose
